...
/* harmony import */ var ionic_selectable__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ionic-selectable */ "./node_modules/ionic-selectable/__ivy_ngcc__/esm2015/ionic-selectable.min.js");
...
/* harmony import */ var _validators_validators_password__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../_validators/validators.password */ "./src/app/_validators/validators.password.ts");
...
let RegistrationPage = class RegistrationPage {
    constructor(formBuilder, service, camera, helperService, oneSignal, toastController, navCtrl, actionSheetController, device, el, translate, router) {
        ...
        this.registerForm = formBuilder.group({
            ...
            password: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                    ...
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])[A-Za-z\d$@$!%*?&].{7,50}')
                ])],
    ...
    scrollToFirstInvalidControl() {
        const firstInvalidControl = this.el.nativeElement.querySelector("form .ng-invalid");
