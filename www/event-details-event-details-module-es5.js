(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["event-details-event-details-module"], {
    ...
    /***/
    function srcAppEventDetailsEventDetailsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppEventDetailsEventDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _common_component_topic_images_topic_images_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var EventDetailsPage = /*#__PURE__*/function () {
        function EventDetailsPage(modalCtrl, router, service, helperService, translateService, alertController, route, util, iab) {
          var _this2 = this;
          ...
          this.route.queryParams.subscribe(function (_res) {
            ...
            _this2.getEventById(_this2.selectedId);
          });
        ...
        _createClass(EventDetailsPage, [{
          ...
          key: "getEventById",
          value: function getEventById(_id) {
            var _this4 = this;

            this.loaded = false;
            this.helperService.show();
            this.service.getEventsByID(_id).subscribe(function (_res) {
              _this4.loaded = true;
              _this4.details = _res;

              _this4.helperService.hide();

              var tempDT = _this4.details.endDate.replaceAll('/', '-') + ' ' + _this4.details.endTime;

              _this4.isBefore = moment__WEBPACK_IMPORTED_MODULE_11__(tempDT).isBefore(new Date());
            }, function (error) {
              _this4.helperService.hide();
          ...
          value: function addFavorite(_id) {
            ...
            if (this.guest) {
              ...
              this.service.addfavoriteEvent(_id).subscribe(function (_res) {
          ...
          value: function getProfile(_type) {
            ...
            this.service.getProfile().subscribe(function (_res) {
              ...
              _this6.favList = _res.favouriteEventsList;
          ...
          value: function removeFavorite() {
            ...
            this.service.deleteFavoriteEvent(this.selectedId).subscribe(function (_res) {
