...
/* harmony import */ var _my_profile_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./my-profile-routing.module */ "./src/app/my-profile/my-profile-routing.module.ts");
...
/* harmony import */ var _common_component_farm_images_farm_images_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../common-component/farm-images/farm-images.component */ "./src/app/common-component/farm-images/farm-images.component.ts");
...
let MyProfilePage = class MyProfilePage {
    constructor(service, router, authService, helperService, translateService, modalCtrl, appVersion, navCtrl, util) {
    ...
    ngOnInit() {
        ...
        this.appVersion.getVersionCode().then((getVersionCode) => {
