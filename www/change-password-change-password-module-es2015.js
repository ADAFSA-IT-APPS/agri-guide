...
/* harmony import */ var src_app_validators_validators_password__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/_validators/validators.password */ "./src/app/_validators/validators.password.ts");
...
let ChangePasswordPage = class ChangePasswordPage {
    constructor(formBuilder, service, helperService, authService) {
        ...
        this.changeForm = formBuilder.group({
            password: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                    ...
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&].{5,50}')
                ])],
