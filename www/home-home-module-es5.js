(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _common_component_common_component_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      HomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], _common_component_common_component_module__WEBPACK_IMPORTED_MODULE_7__["CommonComponentPageModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_5__["HomePageRoutingModule"]],
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _common_component_category_modal_category_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../common-component/category-modal/category-modal.component */
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(menuCtrl, service, util, oneSignal, helperService, modalCtrl, ngZone, router) {
          var _this = this;
        ...
        _createClass(HomePage, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      this.util.observNoti().subscribe(function (_res) {
                        console.log('observNotify', _res);

                        _this2.ngZone.run(function () {
                          _this2.generalNotification = JSON.parse(localStorage.getItem('generalNotifications'));
                        });

                        console.log('generalNotification', _this2.generalNotification);
                      });
          ...
          key: "ngDoCheck",
          value: function ngDoCheck() {//this.generalNotification = JSON.parse(localStorage.getItem('generalNotifications'));
          }
        }, {
          key: "removeNoti",
          value: function removeNoti() {
          ...
          value: function getProfile() {
            ...
            this.service.getProfile().subscribe(function (_res) {
              ...
              _this3.oneSignal.getIds().then(function (data) {
              ...
              _this3.util.chatService();

              _this3.profileData = _res;
              _this3.farming = _res.categoryList;
              _this3.dummy = [];
          ...
          key: "scanImage",
          value: function scanImage(_id) {
            this.router.navigate(['/scan-image'], {
              queryParams: {
                cid: _id
              }
            });
          ...
          key: "openModal",
          value: function openModal(_type) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (data) {
                        if (data.data && data.role == '1') {
                          _this4.scanSelectedCat = data.data.cat;

                          _this4.scanImage(_this4.scanSelectedCat.id);
                        } else if (data.data && data.role == '2') {
                          _this4.goToAnimalSymptoms();
                        }
                      });
                      _context2.next = 6;
          ...
          key: "goToAnimalSymptoms",
          value: function goToAnimalSymptoms() {
